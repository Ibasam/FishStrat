Ibasam <-
  ...
  ) 
  {
    ...
    #GENETIC ON / OFF - al - 31/01/2023
    #54 = genetic_on_ should the genetic material of parents be given to their offspring?(0=no, anything else=yes)
    #def$colParam[54] <- 0 #OFF

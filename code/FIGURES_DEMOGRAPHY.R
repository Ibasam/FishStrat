...
for (i in 1:ncol(SCN)){
  ...
  for (iEXPE in SCN[,i]){
    ...
    load(paste0("results/DEMOGRAPHY/DEMOGRAPHY",iEXPE,".RData"))
...
load(paste0("results/DEMOGRAPHY/DEMOGRAPHY",101,".RData"))
...
pdf(file="results/DEMOGRAPHY.pdf")
...
ylab="Relative Abundance" # Pre-Fisheries Abundance
...
plot(NULL,xlim=c(1,nInit+nYear),ylim=c(0,max(unlist(tmp), na.rm=TRUE)),xlab=xlab,ylab=ylab,main="Dispersal: 0% / Exploitation all pop.", cex.main=0.7)
...
plot(NULL,xlim=c(1,nInit+nYear),ylim=c(0,max(unlist(tmp), na.rm=TRUE)),xlab=xlab,ylab=ylab,main="Dispersal: 15% / Exploitation all pop.", cex.main=0.7)
rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
...
plot(NULL,xlim=c(1,nInit+nYear),ylim=c(0,max(unlist(tmp), na.rm=TRUE)),xlab=xlab,ylab=ylab,main="Dispersal: 30% / Exploitation all pop.", cex.main=0.7)
rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
...
plot(NULL,xlim=c(1,nInit+nYear),ylim=c(0,max(unlist(tmp), na.rm=TRUE)),xlab=xlab,ylab=ylab,main="Dispersal: 15% / Exploitation source pop.", cex.main=0.7)
rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
...
plot(NULL,xlim=c(1,nInit+nYear),ylim=c(0,max(unlist(tmp), na.rm=TRUE)),xlab=xlab,ylab=ylab,main="Dispersal: 30% / Exploitation source pop.", cex.main=0.7)
rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
...
plot(NULL,xlim=c(1,nInit+nYear),ylim=c(0,max(unlist(tmp), na.rm=TRUE)),xlab=xlab,ylab=ylab,main="Dispersal: 15% / Conservation source pop.", cex.main=0.7)
rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
...
plot(NULL,xlim=c(1,nInit+nYear),ylim=c(0,max(unlist(tmp), na.rm=TRUE)),xlab=xlab,ylab=ylab,main="Dispersal: 30% / Conservation source pop.", cex.main=0.7)
rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
...
#col=c("#000000", "#1874CD", "#009ACD", "#00BFFF", "#228B22", "#66CD00", "#7FFF00")
col.sinks=c("dodgerblue2", "deepskyblue")
col.sources=c("brown1", "lightcoral", "white")
par(mfcol=c(3,2))
...
### FISHING ALL
plot(NULL,xlim=c(1,length(frates_vec)),ylim=c(0,max(tmp, na.rm=TRUE)),xlab=xlab,ylab=ylab,main="Exploitation all pop.",xaxt='n')
axis(1,1:length(frates_vec), frates_vec)
#for (i in 1:ncol(SCN)){
points(1:length(frates_vec),apply(tmp[,,1],1,mean),col=col[1],pch=1,bg=col[1],cex=2,type='l',lwd=lwd)
points(1:length(frates_vec),apply(tmp[,,2],1,mean),col="grey",pch=1,bg="grey",cex=2,type='l',lwd=lwd)
points(1:length(frates_vec),apply(tmp[,,5],1,mean),col="lightgrey",pch=1,bg="lightgrey",cex=2,type='l',lwd=lwd)
# for (j in 1:13){
#   #points(rep(j,nSIMUL),tmp[j,,1],col=col[1],pcDisp. 0%,bg=col[1])
#   points(j,mean(tmp[j,,1]),col=col[1],pch=1,bg=col[1],cex=2,type='l')
...
#   
#   #points(rep(j,nSIMUL),tmp[j,,2],col=col[2],pcDisp. 0%,bg=col[2])
#   points(j,mean(tmp[j,,2]),col=col[2],pch=1,bg=col[2],cex=2)
...
#   
#   #points(rep(j,nSIMUL),tmp[j,,5],col=col[5],pcDisp. 0%,bg=col[5])
#   points(j,mean(tmp[j,,5]),col=col[5],pch=1,bg=col[5],cex=2)
...
# }
legend("bottomleft",c("Disp. 0%","Disp. 15%","Disp. 30%"),col=c(1,"grey","lightgrey"),lty=rep(1,3),lwd=rep(2,3),bty="n")


### FISHING SOURCES
plot(NULL,xlim=c(1,length(frates_vec)),ylim=c(0,max(tmp, na.rm=TRUE)),xlab=xlab,ylab=ylab,main="Exploitation source pop.",xaxt='n')
axis(1,1:length(frates_vec), frates_vec)
points(1:length(frates_vec),apply(tmp[,,1],1,mean),col=col[1],pch=1,bg=col[1],cex=2,type='l',lwd=lwd)
points(1:length(frates_vec),apply(tmp[,,3],1,mean),col=col.sources[1],pch=1,bg=col.sources[1],cex=2,type='l',lwd=lwd)
points(1:length(frates_vec),apply(tmp[,,6],1,mean),col=col.sources[2],pch=1,bg=col.sources[2],cex=2,type='l',lwd=lwd)
#for (i in 1:ncol(SCN)){
# for (j in 1:13){
#   #points(rep(j,nSIMUL),tmp[j,,1],col=col[1],pch=1,bg=col[1])
#   points(j,mean(tmp[j,,1]),col=col[1],pch=1,bg=col[1],cex=2)
#   #segments(j,mean(tmp[j,,1])-sd(tmp[j,,1]),j,mean(tmp[j,,1])-sd(tmp[j,,1]),col=col[i])
#   #x<-matrix(1:13,13,nSIMUL);y<-tmp[,,1]
#   #lines(lowess(x,y,f = 1/3), col = col[1], lty = 1)
#   
#   #points(rep(j,nSIMUL),tmp[j,,3],col=col[3],pch=1,bg=col[3])
#   points(j,mean(tmp[j,,3]),col=col[2],pch=1,bg=col[2],cex=2)
#   #segments(j,mean(tmp[j,,3])-sd(tmp[j,,3]),j,mean(tmp[j,,3])-sd(tmp[j,,3]),col=col[i])
#   #x<-matrix(1:13,13,nSIMUL);y<-tmp[,,3]
#   #lines(lowess(x,y,f = 1/3), col = col[2], lty = 1)
#   
#   #points(rep(j,nSIMUL),tmp[j,,5],col=col[5],pcDisp. 0%,bg=col[5])
#   points(j,mean(tmp[j,,7]),col=col[5],pch=1,bg=col[5],cex=2)
#   #segments(j,mean(tmp[j,,5])-sd(tmp[j,,5]),j,mean(tmp[j,,5])-sd(tmp[j,,5]),col=col[i])
#   #x<-matrix(1:13,13,nSIMUL);y<-tmp[,,13]
#   #lines(lowess(x,y,f = 1/3), col = col[5], lty = 1)
# }
legend("bottomleft",c("Disp. 0%","Disp. 15%","Disp. 30%"),col=c(1,col.sources),lty=rep(1,3),bty="n")


### FISHING SINKS
plot(NULL,xlim=c(1,length(frates_vec)),ylim=c(0,max(tmp, na.rm=TRUE)),xlab=xlab,ylab=ylab,main="Conservation source pop.",xaxt='n')
axis(1,1:length(frates_vec), frates_vec)
points(1:length(frates_vec),apply(tmp[,,1],1,mean),col=col[1],pch=1,bg=col[1],cex=2,type='l',lwd=lwd)
points(1:length(frates_vec),apply(tmp[,,4],1,mean),col=col.sinks[1],pch=1,bg=col.sinks[1],cex=2,type='l',lwd=lwd)
points(1:length(frates_vec),apply(tmp[,,7],1,mean),col=col.sinks[2],pch=1,bg=col.sinks[2],cex=2,type='l',lwd=lwd)
#for (i in 1:ncol(SCN)){
# for (j in 1:13){
#   #points(rep(j,nSIMUL),tmp[j,,1],col=col[1],pch=1,bg=col[1])
#   points(j,mean(tmp[j,,1]),col=col[1],pch=1,bg=col[1],cex=2)
...
#   #lines(lowess(x,y,f = 1/3), col = col[1], lty = 1)
#   
#   #points(rep(j,nSIMUL),tmp[j,,4],col=col[2],pcDisp. 0%,bg=col[2])
#   points(j,mean(tmp[j,,4]),col=col[2],pch=1,bg=col[2],cex=2)
#   #segments(j,mean(tmp[j,,3])-sd(tmp[j,,3]),j,mean(tmp[j,,3])-sd(tmp[j,,3]),col=col[i])
...
#   #lines(lowess(x,y,f = 1/3), col = col[5], lty = 1)
# }
legend("bottomleft",c("Disp. 0%","Disp. 15%","Disp. 30%"),col=c(1,col.sinks),lty=rep(1,3),lwd=rep(2,3),bty="n")
...
plot(NULL,xlim=c(1,length(frates_vec)),ylim=c(0,max(tmp, na.rm=TRUE)),xlab=xlab,ylab=ylab,main="Dispersal: 15%",xaxt='n')
axis(1,1:length(frates_vec), frates_vec)
points(1:length(frates_vec),apply(tmp[,,2],1,mean),col="grey",pch=1,bg="grey",cex=2,type='l',lwd=lwd)
points(1:length(frates_vec),apply(tmp[,,3],1,mean),col=col.sources[1],pch=1,bg=col.sources[1],cex=2,type='l',lwd=lwd)
points(1:length(frates_vec),apply(tmp[,,4],1,mean),col=col.sinks[1],pch=1,bg=col.sinks[1],cex=2,type='l',lwd=lwd)
...
#   
#   #points(rep(j,nSIMUL),tmp[j,,2],col=col[2],pcDisp. 0%,bg=col[2])
#   points(j,mean(tmp[j,,3]),col=col[3],pch=1,bg=col[3],cex=2)
#   #segments(j,mean(tmp[j,,2])-sd(tmp[j,,2]),j,mean(tmp[j,,2])-sd(tmp[j,,1]),col=col[i])
#   #x<-matrix(1:6,6,nSIMUL);y<-tmp[,,3]
#   #lines(lowess(x,y,f = 1/3), col = col[3], lty = 1)
#   
#   #points(rep(j,nSIMUL),tmp[j,,5],col=col[5],pcDisp. 0%,bg=col[5])
#   points(j,mean(tmp[j,,4]),col=col[4],pch=1,bg=col[4],cex=2)
#   #segments(j,mean(tmp[j,,5])-sd(tmp[j,,5]),j,mean(tmp[j,,5])-sd(tmp[j,,5]),col=col[i])
#   #x<-matrix(1:6,6,nSIMUL);y<-tmp[,,4]
#   #lines(lowess(x,y,f = 1/3), col = col[4], lty = 1)
# }
legend("bottomleft",c("Expl. all","Expl. source","Conserv. source"),col=c("grey",col.sources[1],col.sinks[1]),lty=rep(1,3),lwd=rep(2,3),bty="n")


### DISPERSAL 0.7 FUNCTION OF LOCAL EXPLOITATION RATE
plot(NULL,xlim=c(1,length(frates_vec)),ylim=c(0,max(tmp, na.rm=TRUE)),xlab=xlab,ylab=ylab,main="Dispersal: 30%",xaxt='n')
axis(1,1:length(frates_vec), frates_vec)
points(1:length(frates_vec),apply(tmp[,,5],1,mean),col="lightgrey",pch=1,bg="grey",cex=2,type='l',lwd=lwd)
points(1:length(frates_vec),apply(tmp[,,6],1,mean),col=col.sources[2],pch=1,bg=col.sources[2],cex=2,type='l',lwd=lwd)
points(1:length(frates_vec),apply(tmp[,,7],1,mean),col=col.sinks[2],pch=1,bg=col.sinks[2],cex=2,type='l',lwd=lwd)
#for (i in 1:ncol(SCN)){
# for (j in 1:13){
...
#   
#   #points(rep(j,nSIMUL),tmp[j,,2],col=col[2],pcDisp. 0%,bg=col[2])
#   points(j,mean(tmp[j,,6]),col=col[6],pch=1,bg=col[6],cex=2)
#   #segments(j,mean(tmp[j,,2])-sd(tmp[j,,2]),j,mean(tmp[j,,2])-sd(tmp[j,,1]),col=col[i])
#   #x<-matrix(1:6,6,nSIMUL);y<-tmp[,,6]
#   #lines(lowess(x,y,f = 1/3), col = col[6], lty = 1)
#   
#   #points(rep(j,nSIMUL),tmp[j,,5],col=col[5],pcDisp. 0%,bg=col[5])
#   points(j,mean(tmp[j,,7]),col=col[7],pch=1,bg=col[7],cex=2)
#   #segments(j,mean(tmp[j,,5])-sd(tmp[j,,5]),j,mean(tmp[j,,5])-sd(tmp[j,,5]),col=col[i])
#   #x<-matrix(1:6,6,nSIMUL);y<-tmp[,,7]
#   #lines(lowess(x,y,f = 1/3), col = col[7], lty = 1)
# }
legend("bottomleft",c("Expl. all","Expl. source","Conserv. source"),col=c("lightgrey",col.sources[2],col.sinks[2]),lty=rep(1,3),lwd=rep(2,3),bty="n")
...
plot(NULL,xlim=c(1,nInit+nYear),ylim=c(0,max(unlist(tmp), na.rm=TRUE)),xlab=xlab,ylab=ylab,main="Dispersal: 15% / Exploitation sources pop.", cex.main=0.7)
rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
for (j in 1:length(tmp[[3]])){
  points(1:50,tmp[[3]][[j]],col=col[j],type='l',lwd=lwd)
}
...
plot(NULL,xlim=c(1,nInit+nYear),ylim=c(0,max(unlist(tmp), na.rm=TRUE)),xlab=xlab,ylab=ylab,main="Dispersal: 30% / Exploitation sources pop.", cex.main=0.7)
rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
for (j in 1:length(tmp[[6]])){
  points(1:50,tmp[[6]][[j]],col=col[j],type='l',lwd=lwd)
}
...
#   #lines(lowess(x,y,f = 1/3), col = col[5], lty = 1)
# }
legend("topleft",c("Disp. 0%","Disp. 15%","Disp. 30%"),col=c(1,"grey","lightgrey"),lty=rep(1,3),lwd=rep(2,3),bty="n")
...
#   #lines(lowess(x,y,f = 1/3), col = col[5], lty = 1)
# }
legend("topleft",c("Disp. 0%","Disp. 15%","Disp. 30%"),col=c(1,col.sources),lty=rep(1,3),lwd=rep(2,3),bty="n")
...
#   #lines(lowess(x,y,f = 1/3), col = col[5], lty = 1)
# }
legend("topleft",c("Disp. 0%","Disp. 15%","Disp. 30%"),col=c(1,col.sinks),lty=rep(1,3),lwd=rep(2,3),bty="n")
...
#   #lines(lowess(x,y,f = 1/3), col = col[4], lty = 1)
# }
legend("topleft",c("Expl. all","Expl. source","Conserv. source"),col=c("grey",col.sources[1],col.sinks[1]),lty=rep(1,3),lwd=rep(2,3),bty="n")
...
#   #lines(lowess(x,y,f = 1/3), col = col[7], lty = 1)
# }
legend("topleft",c("Expl. all","Expl. source","Conserv. source"),col=c("lightgrey",col.sources[2],col.sinks[2]),lty=rep(1,3),lwd=rep(2,3),bty="n")
...
#   }}
# 
# if (scenarioFishing==1){ # exploit. sources/neutral
#   for (i in 1:npop) {
...
#   }}
# 
# if (scenarioFishing==2){ # conserv. sources/neutral
#   for (i in 1:npop) {
#     if (dat$Type[i]=="sink") tmp[i,] <- fratesSink
#     if (dat$Type[i]=="neutral") tmp[i,] <- fratesNeutral
...
points(apply(metapops.exp.means[,,2],1,mean),apply(metapops.means.rel[,,2],1,mean),col="grey",pch=1,bg="grey",cex=2,type='b',lwd=4)
points(apply(metapops.exp.means[,,3],1,mean),apply(metapops.means.rel[,,3],1,mean),col=col.sources[1],pch=1,bg=col.sources[1],cex=2,type='b',lwd=4)
points(apply(metapops.exp.means[,,4],1,mean),apply(metapops.means.rel[,,4],1,mean),col=col.sinks[1],pch=1,bg=col.sinks[1],cex=2,type='b',lwd=4)
# for (j in 1:nrow(SCN)){
#   points(mean(metapops.exp.means[j,,2]),mean(metapops.means.rel[j,,2]),col="grey",pch=1,bg="grey",cex=2,type="b")
#   
#   points(mean(metapops.exp.means[j,,3]),mean(metapops.means.rel[j,,3]),col=col.sources[1],pch=1,bg=col.sources[1],cex=2)
# 
#   points(mean(metapops.exp.means[j,,4]),mean(metapops.means.rel[j,,4]),col=col.sinks[1],pch=1,bg=col.sinks[1],cex=2)
# }
# #polynomial ? loess ?
# x_2<-y_2<-NULL
# for (j in 1:nrow(SCN)){
...
#legend("topright",c("Expl. all","Expl. source","Conserv. source"),col=c("grey",col.sources[1],col.sinks[1]),lty=rep(1,3),bty="n")


#### DISPERSAL 0.7 FUNCTION OF GLOBAL EXPLOITATION RATE
#plot(NULL,xlim=c(0,0.55),ylim=c(0,max(metapops.means.rel, na.rm=TRUE)),xlab="Global Exploitation rates",ylab="Relative Mean Metapop Ab",main="Disp. 30%")
points(apply(metapops.exp.means[,,5],1,mean),apply(metapops.means.rel[,,5],1,mean),col="lightgrey",pch=1,bg="lightgrey",cex=2,type='b',lwd=4)
points(apply(metapops.exp.means[,,6],1,mean),apply(metapops.means.rel[,,6],1,mean),col=col.sources[2],pch=1,bg=col.sources[2],cex=2,type='b',lwd=4)
points(apply(metapops.exp.means[,,7],1,mean),apply(metapops.means.rel[,,7],1,mean),col=col.sinks[2],pch=1,bg=col.sinks[2],cex=2,type='b',lwd=4)
# for (j in 1:nrow(SCN)){
#   points(mean(metapops.exp.means[j,,5]),mean(metapops.means.rel[j,,5]),col="lightgrey",pch=1,bg="lightgrey",cex=2)
# 
#   points(mean(metapops.exp.means[j,,6]),mean(metapops.means.rel[j,,6]),col=col.sources[2],pch=1,bg=col.sources[2],cex=2)
# 
#   points(mean(metapops.exp.means[j,,7]),mean(metapops.means.rel[j,,7]),col=col.sinks[2],pch=1,bg=col.sinks[2],cex=2)
# }
# x_2<-y_2<-NULL
# for (j in 1:nrow(SCN)){
...
#legend("topright",c("Expl. all","Expl. source","Conserv. source"),col=c("lightgrey",col.sources[2],col.sinks[2]),lty=rep(1,3),bty="n")

legend("topright"
       ,c("Exploitation all pop.","Exploit. source / Disp. 15%","Exploit. source / Disp. 30%","Conserv. source / Disp. 15%","Conserv. source / Disp. 30%")
       ,col=c("grey",col.sources[1:2],col.sinks)
       ,text.col=c("grey",col.sources[1:2],col.sinks)
       ,pch=rep(16,5)
       #,lty=c(1,1,2,1,2)
       ,bty="n")
...
#for (i in 1:ncol(SCN)){
if(Points){
  points(apply(tmp2[,,1],1,mean),apply(tmp[,,1],1,mean),col="darkgrey",pch=1,bg="darkgrey",cex=cex,type='b',lwd=4)
  
  points(apply(tmp2[,,2],1,mean),apply(tmp[,,2],1,mean),col="grey",pch=1,bg="grey",cex=cex,type='b',lwd=4)
  points(apply(tmp2[,,3],1,mean),apply(tmp[,,3],1,mean),col=col.sources[1],pch=1,bg=col.sources[1],cex=cex,type='b',lwd=4)
  points(apply(tmp2[,,4],1,mean),apply(tmp[,,4],1,mean),col=col.sinks[1],pch=1,bg=col.sinks[1],cex=cex,type='b',lwd=4)
  
  #points(apply(tmp2[,,5],1,mean),apply(tmp[,,5],1,mean),col="lightgrey",pch=1,bg="lightgrey",cex=cex,type='b',lwd=4)
  points(apply(tmp2[,,6],1,mean),apply(tmp[,,6],1,mean),col=col.sources[2],pch=1,bg=col.sources[2],cex=cex,type='b',lwd=4)
  points(apply(tmp2[,,7],1,mean),apply(tmp[,,7],1,mean),col=col.sinks[2],pch=1,bg=col.sinks[2],cex=cex,type='b',lwd=4)
}
...
# for (j in 1:13){
#   #points(rep(j,nSIMUL),tmp[j,,1],col=col[1],pcDisp. 0%,bg=col[1])
#   if(Points) points(mean(tmp2[j,,1]),mean(tmp[j,,1]),col=col[1],pch=1,bg=col[1],cex=cex[j],type='b',lwd=4)
...
#points(rep(j,nSIMUL),tmp[j,,2],col=col[2],pcDisp. 0%,bg=col[2])
#points(mean(tmp2[j,,2]),mean(tmp[j,,2]),col=col[2],pch=1,bg=col[2],cex=2)
#segments(j,mean(tmp[j,,2])-sd(tmp[j,,2]),j,mean(tmp[j,,2])-sd(tmp[j,,1]),col=col[i])
#x<-tmp2[,,2];y<-tmp[,,2]
#lines(lowess(x,y,f = 1/3), col = col[2], lty = 1)

#points(rep(j,nSIMUL),tmp[j,,5],col=col[5],pcDisp. 0%,bg=col[5])
#points(mean(tmp2[j,,5]),mean(tmp[j,,5]),col=col[5],pch=1,bg=col[5],cex=2)
#segments(j,mean(tmp[j,,5])-sd(tmp[j,,5]),j,mean(tmp[j,,5])-sd(tmp[j,,5]),col=col[i])
#x<-tmp2[,,5];y<-tmp[,,5]
#lines(lowess(x,y,f = 1/3), col = col[5], lty = 1)
#}
#legend("topleft",c("Disp. 0%","Disp. 15%","Disp. 30%"),col=c(1,1,1),lty=c(1,1,2),bty="n")
...
# #plot(NULL,xlim=xlim,ylim=c(0,max(tmp, na.rm=TRUE)),xlab=xlab,ylab=ylab,main="Exploitation source pop.")#,xaxt='n')
# #axis(1,1:6, frates_vec)
# #for (i in 1:ncol(SCN)){
# for (j in 1:13){
#   #points(rep(j,nSIMUL),tmp[j,,1],col=col[1],pcDisp. 0%,bg=col[1])
#   #points(mean(tmp2[j,,1]),mean(tmp[j,,1]),col=col[1],pch=1,bg=col[1],cex=2)
#   #segments(j,mean(tmp[j,,1])-sd(tmp[j,,1]),j,mean(tmp[j,,1])-sd(tmp[j,,1]),col=col[i])
#   #x<-matrix(1:6,6,nSIMUL);y<-tmp[,,1]
#   #lines(lowess(x,y,f = 1/3), col = col[1], lty = 1)
#   
#   #points(rep(j,nSIMUL),tmp[j,,3],col=col[3],pcDisp. 0%,bg=col[3])
#   if(Points)  points(mean(tmp2[j,,3]),mean(tmp[j,,3]),col=col.sources[1],pch=1,bg=col.sources[1],cex=cex[j])
...
#   
#   #points(rep(j,nSIMUL),tmp[j,,5],col=col[5],pcDisp. 0%,bg=col[5])
#   points(mean(tmp2[j,,6]),mean(tmp[j,,6]),col=col.sources[2],pch=1,bg=col.sources[2],cex=cex[j])
#   if(text) text(mean(tmp2[j,,6]),mean(tmp[j,,6]),frates_vec[j],col=col.sources[2],cex=cex[j])
#   #segments(j,mean(tmp[j,,5])-sd(tmp[j,,5]),j,mean(tmp[j,,5])-sd(tmp[j,,5]),col=col[i])
#   #x<-tmp2[,,6];y<-tmp[,,6]
#   #lines(lowess(x,y,f = 1/3), col = col[5], lty = 1)
# }
# #legend("topleft",c("Disp. 0%","Disp. 15%","Disp. 30%"),col=col[c(1,3,6)],lty=rep(1,3),bty="n")
# 
# if(lines){
# y=x=NULL
# for (j in 1:13){
...
# #plot(NULL,xlim=xlim,ylim=c(0,max(tmp, na.rm=TRUE)),xlab=xlab,ylab=ylab,main="Conservation source pop.", cex.main=0.7)#,xaxt='n')
# #axis(1,1:6, frates_vec)
# #for (i in 1:ncol(SCN)){
# for (j in 1:13){
#   #points(rep(j,nSIMUL),tmp[j,,1],col=col[1],pcDisp. 0%,bg=col[1])
...
#   
#   #points(rep(j,nSIMUL),tmp[j,,4],col=col[2],pcDisp. 0%,bg=col[2])
#   if(Points) points(mean(tmp2[j,,4]),mean(tmp[j,,4]),col=col.sinks[1],pch=1,bg=col.sinks[1],cex=cex[j])
...
#   
#   #points(rep(j,nSIMUL),tmp[j,,5],col=col[5],pcDisp. 0%,bg=col[5])
#   if(Points) points(mean(tmp2[j,,7]),mean(tmp[j,,7]),col=col.sinks[2],pch=1,bg=col.sinks[2],cex=cex[j])
...
legend("topright"
       ,c("Exploit. all","Exploit. source / Disp. 15%","Exploit. source / Disp. 30%","Conserv. source / Disp. 15%","Conserv. source / Disp. 30%")
       ,col=c("grey",col.sources[1:2],col.sinks)
       ,text.col=c("grey",col.sources[1:2],col.sinks)
       ,pch=rep(16,5)
       #,lty=c(1,1,2,1,2)
...
plot(NULL,xlim=c(1,nInit+nYear),ylim=ylim,xlab=xlab,ylab=ylab,main="Dispersal: 0% / Exploitation all pop.", cex.main=0.7)
rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
for (j in 1:length(tmp[[1]])){
  points(1:50,tmp[[1]][[j]],col=col[j],type='l',lwd=lwd)
}
...
plot(NULL,xlim=c(1,nInit+nYear),ylim=ylim,xlab=xlab,ylab=ylab,main="Dispersal: 15% / Exploitation all pop.", cex.main=0.7)
rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
for (j in 1:length(tmp[[2]])){
  points(1:50,tmp[[2]][[j]],col=col[j],type='l',lwd=lwd)
}
...
plot(NULL,xlim=c(1,nInit+nYear),ylim=ylim,xlab=xlab,ylab=ylab,main="Dispersal: 30% / Exploitation all pop.", cex.main=0.7)
rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
for (j in 1:length(tmp[[5]])){
  points(1:50,tmp[[5]][[j]],col=col[j],type='l',lwd=lwd)
}
...
plot(NULL,xlim=c(1,nInit+nYear),ylim=ylim,xlab=xlab,ylab=ylab,main="Dispersal: 15% / Exploitation sources pop.", cex.main=0.7)
rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
for (j in 1:length(tmp[[3]])){
  points(1:50,tmp[[3]][[j]],col=col[j],type='l',lwd=lwd)
}
...
plot(NULL,xlim=c(1,nInit+nYear),ylim=ylim,xlab=xlab,ylab=ylab,main="Dispersal: 30% / Exploitation sources pop.", cex.main=0.7)
rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
for (j in 1:length(tmp[[6]])){
  points(1:50,tmp[[6]][[j]],col=col[j],type='l',lwd=lwd)
}
...
plot(NULL,xlim=c(1,nInit+nYear),ylim=ylim,xlab=xlab,ylab=ylab,main="Dispersal: 15% / Conservation source pop.", cex.main=0.7)
rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
for (j in 1:length(tmp[[4]])){
  points(1:50,tmp[[4]][[j]],col=col[j],type='l',lwd=lwd)
}
...
plot(NULL,xlim=c(1,nInit+nYear),ylim=ylim,xlab=xlab,ylab=ylab,main="Dispersal: 30% / Conservation source pop.", cex.main=0.7)
rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
for (j in 1:length(tmp[[7]])){
  points(1:50,tmp[[7]][[j]],col=col[j],type='l',lwd=lwd)
}
...
### FISHING ALL
plot(NULL,xlim=c(1,length(frates_vec)),ylim=ylim,xlab=xlab,ylab=ylab,main="Exploitation all pop.",xaxt='n')
axis(1,1:length(frates_vec), frates_vec)
#for (i in 1:ncol(SCN)){
points(1:length(frates_vec),apply(tmp[,,1],1,mean),col=col[1],pch=1,bg=col[1],cex=2,type='l',lwd=lwd)
points(1:length(frates_vec),apply(tmp[,,2],1,mean),col="grey",pch=1,bg="grey",cex=2,type='l',lwd=lwd)
...
### FISHING SOURCES
plot(NULL,xlim=c(1,length(frates_vec)),ylim=ylim,xlab=xlab,ylab=ylab,main="Exploitation source pop.",xaxt='n')
axis(1,1:length(frates_vec), frates_vec)
points(1:length(frates_vec),apply(tmp[,,1],1,mean),col=col[1],pch=1,bg=col[1],cex=2,type='l',lwd=lwd)
points(1:length(frates_vec),apply(tmp[,,3],1,mean),col=col.sources[1],pch=1,bg=col.sources[1],cex=2,type='l',lwd=lwd)
points(1:length(frates_vec),apply(tmp[,,6],1,mean),col=col.sources[2],pch=1,bg=col.sources[2],cex=2,type='l',lwd=lwd)
...
### FISHING SINKS
plot(NULL,xlim=c(1,length(frates_vec)),ylim=ylim,xlab=xlab,ylab=ylab,main="Conservation source pop.",xaxt='n')
axis(1,1:length(frates_vec), frates_vec)
points(1:length(frates_vec),apply(tmp[,,1],1,mean),col=col[1],pch=1,bg=col[1],cex=2,type='l',lwd=lwd)
points(1:length(frates_vec),apply(tmp[,,4],1,mean),col=col.sinks[1],pch=1,bg=col.sinks[1],cex=2,type='l',lwd=lwd)
points(1:length(frates_vec),apply(tmp[,,7],1,mean),col=col.sinks[2],pch=1,bg=col.sinks[2],cex=2,type='l',lwd=lwd)
...
### DISPERSAL 0.85 FUNCTION OF LOCAL EXPLOITATION RATE
plot(NULL,xlim=c(1,length(frates_vec)),ylim=ylim,xlab=xlab,ylab=ylab,main="Dispersal: 15%",xaxt='n')
axis(1,1:length(frates_vec), frates_vec)
points(1:length(frates_vec),apply(tmp[,,2],1,mean),col="grey",pch=1,bg="grey",cex=2,type='l',lwd=lwd)
points(1:length(frates_vec),apply(tmp[,,3],1,mean),col=col.sources[1],pch=1,bg=col.sources[1],cex=2,type='l',lwd=lwd)
points(1:length(frates_vec),apply(tmp[,,4],1,mean),col=col.sinks[1],pch=1,bg=col.sinks[1],cex=2,type='l',lwd=lwd)
...
### DISPERSAL 0.7 FUNCTION OF LOCAL EXPLOITATION RATE
plot(NULL,xlim=c(1,length(frates_vec)),ylim=ylim,xlab=xlab,ylab=ylab,main=" Dispersal: 30%",xaxt='n')
axis(1,1:length(frates_vec), frates_vec)
points(1:length(frates_vec),apply(tmp[,,5],1,mean),col="lightgrey",pch=1,bg="grey",cex=2,type='l',lwd=lwd)
points(1:length(frates_vec),apply(tmp[,,6],1,mean),col=col.sources[2],pch=1,bg=col.sources[2],cex=2,type='l',lwd=lwd)
points(1:length(frates_vec),apply(tmp[,,7],1,mean),col=col.sinks[2],pch=1,bg=col.sinks[2],cex=2,type='l',lwd=lwd)
...
for (pop in 1:npop){
  ...
  plot(NULL,xlim=c(1,nInit+nYear),ylim=ylim,xlab=xlab,ylab=ylab)#,main="Dispersal: 0% / Exploitation all pop.", cex.main=0.7)
  title("Dispersal: 0% / Exploitation all pop.", col.main = col.type[pop.type[pop]],cex.main=0.7)
  rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
  j=0
  for (iEXPE in SCN[,1]){
    j=j+1
  ...
  plot(NULL,xlim=c(1,nInit+nYear),ylim=ylim,xlab=xlab,ylab=ylab)#,main="Dispersal: 15% / Exploitation all pop.", cex.main=0.7)
  title("Dispersal: 15% / Exploitation all pop.", col.main = col.type[pop.type[pop]],cex.main=0.7)
  rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
  j=0
  for (iEXPE in SCN[,2]){
    j=j+1
  ...
  plot(NULL,xlim=c(1,nInit+nYear),ylim=ylim, xlab=xlab,ylab=ylab)#,main="Dispersal: 30% / Exploitation all pop.", cex.main=0.7)
  title("Dispersal: 30% / Exploitation all pop.", col.main = col.type[pop.type[pop]],cex.main=0.7)
  rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
  j=0
  for (iEXPE in SCN[,5]){
    j=j+1
  ...
  plot(NULL,xlim=c(1,nInit+nYear),ylim=ylim, xlab=xlab,ylab=ylab)#,main="Dispersal: 15% / Exploitation sources pop.", cex.main=0.7)
  title("Dispersal: 15% / Exploitation sources pop.", col.main = col.type[pop.type[pop]],cex.main=0.7)
  rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
  j=0
  for (iEXPE in SCN[,3]){
    j=j+1
  ...
  plot(NULL,xlim=c(1,nInit+nYear),ylim=ylim, xlab=xlab,ylab=ylab)#,main="Dispersal: 30% / Exploitation sources pop.", cex.main=0.7)
  title("Dispersal: 30% / Exploitation sources pop.", col.main = col.type[pop.type[pop]],cex.main=0.7)
  rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
  j=0
  for (iEXPE in SCN[,6]){
    j=j+1
  ...
  text(length(frates_vec)/2,1,paste0(dat$Population[pop]," / ", dat$Type[pop]),col=col.type[pop.type[pop]],cex=1.8)
  ...
  plot(NULL,xlim=c(1,nInit+nYear),ylim=ylim, xlab=xlab,ylab=ylab)#,main="Dispersal: 15% / Conservation source pop.", cex.main=0.7)
  title("Dispersal: 15% / Conservation source pop.", col.main = col.type[pop.type[pop]],cex.main=0.7)
  rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
  j=0
  for (iEXPE in SCN[,4]){
    j=j+1
  ...
  plot(NULL,xlim=c(1,nInit+nYear),ylim=ylim, xlab=xlab,ylab=ylab)#,main="Dispersal: 30% / Conservation source pop.", cex.main=0.7)
  title("Dispersal: 30% / Conservation source pop.", col.main = col.type[pop.type[pop]],cex.main=0.7)
  rect(0,0,10,max(unlist(tmp), na.rm=TRUE), col= "lightgrey",border ="lightgrey")
  j=0
  for (iEXPE in SCN[,7]){
    j=j+1
...
for (pop in 1:npop){
  ...
  title("Exploitation all pop.", col.main = col.type[pop.type[pop]])
  axis(1,1:length(frates_vec), frates_vec)
  #for (i in 1:ncol(SCN)){
  points(1:length(frates_vec),apply(tmp[,,pop,1],1,mean,na.rm=TRUE),col=col[1],pch=1,bg=col[1],cex=2,type='l',lwd=lwd)
  points(1:length(frates_vec),apply(tmp[,,pop,2],1,mean,na.rm=TRUE),col="grey",pch=1,bg="grey",cex=2,type='l',lwd=lwd)
  points(1:length(frates_vec),apply(tmp[,,pop,5],1,mean,na.rm=TRUE),col="lightgrey",pch=1,bg="lightgrey",cex=2,type='l',lwd=lwd)
  
  legend("topright",c("Disp. 0%","Disp. 15%","Disp. 30%"),col=c(1,"grey","lightgrey"),lty=rep(1,3),lwd=rep(2,3),bty="n")
  ...
  axis(1,1:length(frates_vec), frates_vec)
  points(1:length(frates_vec),apply(tmp[,,pop,1],1,mean,na.rm=TRUE),col=col[1],pch=1,bg=col[1],cex=2,type='l',lwd=lwd)
  points(1:length(frates_vec),apply(tmp[,,pop,3],1,mean,na.rm=TRUE),col=col.sources[1],pch=1,bg=col.sources[1],cex=2,type='l',lwd=lwd)
  points(1:length(frates_vec),apply(tmp[,,pop,6],1,mean,na.rm=TRUE),col=col.sources[2],pch=1,bg=col.sources[2],cex=2,type='l',lwd=lwd)
  
  legend("topright",c("Disp. 0%","Disp. 15%","Disp. 30%"),col=c(1,col.sources),lty=rep(1,3),bty="n")
  ...
  axis(1,1:length(frates_vec), frates_vec)
  points(1:length(frates_vec),apply(tmp[,,pop,1],1,mean,na.rm=TRUE),col=col[1],pch=1,bg=col[1],cex=2,type='l',lwd=lwd)
  points(1:length(frates_vec),apply(tmp[,,pop,4],1,mean,na.rm=TRUE),col=col.sinks[1],pch=1,bg=col.sinks[1],cex=2,type='l',lwd=lwd)
  points(1:length(frates_vec),apply(tmp[,,pop,7],1,mean,na.rm=TRUE),col=col.sinks[2],pch=1,bg=col.sinks[2],cex=2,type='l',lwd=lwd)
  
  legend("topright",c("Disp. 0%","Disp. 15%","Disp. 30%"),col=c(1,col.sinks),lty=rep(1,3),lwd=rep(2,3),bty="n")
  ...
  legend("topright",c("Expl. all","Expl. source","Conserv. source"),col=c("grey",col.sources[1],col.sinks[1]),lty=rep(1,3),lwd=rep(2,3),bty="n")
  
  
  ### DISPERSAL 0.7 FUNCTION OF LOCAL EXPLOITATION RATE
  plot(NULL,xlim=c(1,length(frates_vec)),ylim=c(0,max(tmp, na.rm=TRUE)),xlab=xlab,ylab=ylab,main="Dispersal: 30%",xaxt='n')
  axis(1,1:length(frates_vec), frates_vec)
  points(1:length(frates_vec),apply(tmp[,,pop,5],1,mean,na.rm=TRUE),col="lightgrey",pch=1,bg="grey",cex=2,type='l',lwd=lwd)
  points(1:length(frates_vec),apply(tmp[,,pop,6],1,mean,na.rm=TRUE),col=col.sources[2],pch=1,bg=col.sources[2],cex=2,type='l',lwd=lwd)
  points(1:length(frates_vec),apply(tmp[,,pop,7],1,mean,na.rm=TRUE),col=col.sinks[2],pch=1,bg=col.sinks[2],cex=2,type='l',lwd=lwd)
  
  legend("topright",c("Expl. all","Expl. source","Conserv. source"),col=c("lightgrey",col.sources[2],col.sinks[2]),lty=rep(1,3),lwd=rep(2,3),bty="n")
...
for (pop in 1:npop){
  ...
  ### FISHING ALL
  plot(NULL,xlim=c(1,length(frates_vec)),ylim=c(0,max(tmp, na.rm=TRUE)),xlab=xlab,ylab=ylab,xaxt='n')
  title("Exploitation all pop.", col.main = col.type[pop.type[pop]],cex.main=0.7)
  axis(1,1:length(frates_vec), frates_vec)
  #for (i in 1:ncol(SCN)){
  points(1:length(frates_vec),apply(tmp[,,pop,1],1,mean,na.rm=TRUE),col=col[1],pch=1,bg=col[1],cex=2,type='l',lwd=lwd)
  points(1:length(frates_vec),apply(tmp[,,pop,2],1,mean,na.rm=TRUE),col="grey",pch=1,bg="grey",cex=2,type='l',lwd=lwd)
...
#ylab="Abundance"
#ylab="Metapopulation Relative Abundance"
ylab="Ratio Immigrants/Harvest" # Pre-Fisheries Abundance
...
title(paste0(dat$Population[pop]," / ", dat$Type[pop]), col.main = col.type[pop.type[pop]],cex.main=0.7)
#axis(1,apply(tmp[,,pop,1],1,mean,na.rm=TRUE), frates_vec)
#for (i in 1:ncol(SCN)){
#points(apply(tmp2[,,pop,1],1,mean,na.rm=TRUE),apply(tmp[,,pop,1],1,mean,na.rm=TRUE),col=col[1],pch=1,bg=col[1],cex=1+frates_vec)#,type='l',lwd=lwd)
points(apply(tmp2[,,pop,2],1,mean,na.rm=TRUE),apply(tmp[,,pop,2],1,mean,na.rm=TRUE),col="grey",pch=1,bg="grey",cex=1+frates_vec)#,type='l',lwd=lwd)
points(apply(tmp2[,,pop,5],1,mean,na.rm=TRUE),apply(tmp[,,pop,5],1,mean,na.rm=TRUE),col="lightgrey",pch=1,bg="lightgrey",cex=1+frates_vec)#,type='l',lwd=lwd)
abline(h=1,lty=2);abline(v=1,lty=2)
legend("topleft",c("Disp. 15%","Disp. 30%"),col=c("grey","lightgrey"),pch=rep(16,2),bty="n")
...
if(dat$Type[pop]=="source" | dat$Type[pop]=="neutral"){
  ...
  #axis(1,apply(tmp[,,pop,1],1,mean,na.rm=TRUE), frates_vec)
  #points(apply(tmp2[,,pop,1],1,mean,na.rm=TRUE),apply(tmp[,,pop,1],1,mean,na.rm=TRUE),col=col[1],pch=1,bg=col[1],cex=1+frates_vec)#,type='l',lwd=lwd)
  points(apply(tmp2[,,pop,3],1,mean,na.rm=TRUE),apply(tmp[,,pop,3],1,mean,na.rm=TRUE),col=col.sources[1],pch=1,bg=col.sources[1],cex=1+frates_vec)#,type='l',lwd=lwd)
  points(apply(tmp2[,,pop,6],1,mean,na.rm=TRUE),apply(tmp[,,pop,6],1,mean,na.rm=TRUE),col=col.sources[2],pch=1,bg=col.sources[2],cex=1+frates_vec)#,type='l',lwd=lwd)
  #abline(h=1,lty=2);abline(v=1,lty=2)
  legend("topright",c("Disp. 15%","Disp. 30%"),col=c(col.sources),pch=rep(16,2),bty="n")
...
if(dat$Type[pop]=="sink" | dat$Type[pop]=="neutral"){
  ### FISHING SINKS
  #plot(NULL,xlim=xlim,ylim=ylim,xlab=xlab,ylab=ylab,main="Conservation source pop.", cex.main=0.7)#,xaxt='n')
  #axis(1,apply(tmp2[,,pop,1],1,mean,na.rm=TRUE), frates_vec)
  #points(apply(tmp2[,,pop,1],1,mean,na.rm=TRUE),apply(tmp[,,pop,1],1,mean,na.rm=TRUE),col=col[1],pch=1,bg=col[1],cex=1+frates_vec)#,type='l',lwd=lwd)
  points(apply(tmp2[,,pop,4],1,mean,na.rm=TRUE),apply(tmp[,,pop,4],1,mean,na.rm=TRUE),col=col.sinks[1],pch=1,bg=col.sinks[1],cex=1+frates_vec)#,type='l',lwd=lwd)
  points(apply(tmp2[,,pop,7],1,mean,na.rm=TRUE),apply(tmp[,,pop,7],1,mean,na.rm=TRUE),col=col.sinks[2],pch=1,bg=col.sinks[2],cex=1+frates_vec)#,type='l',lwd=lwd)
  abline(h=1,lty=2);abline(v=1,lty=2)
  legend("topright",c("Disp. 15%","Disp. 30%"),col=c(col.sinks),pch=rep(16,2),bty="n")

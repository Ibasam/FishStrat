...
#shuffled=FALSE # to use shuffled data (Area or Distance)
#RUN N SIMULATIONS
#nSIMUL=30
...
for (sim in first:last) {
  ...
  write.fst(df,paste0(dir_results,"results_",Sc_name,"/Metapop_Sc",scenarioConnect,scenarioFishing,scenarioFishingRate,"_Sim",sim,"_test.fst"),compress_rate)
  save(fishing.rates,file=paste0(dir_results,"results_",Sc_name,"/Fishing_rates_Sc",scenarioConnect,scenarioFishing,scenarioFishingRate,"_Sim",sim,"_test.RData"))

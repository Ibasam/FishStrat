...
Sc_name <- paste0("FishStrat_",scenarioConnect,scenarioFishing,scenarioFishingSelective,scenarioFishingRate)
if (Sc_name == "") {
...
for (sim in first:last) {
  ...
  ifelse(dir.exists(paste0('tmp_',Sc_name)),
         unlink(paste0('tmp_',Sc_name), recursive = TRUE), #deletes the file(s) or directories
         FALSE)
  ...
  write.fst(df,paste0(dir_results,"results_",Sc_name,"/Metapop_Sc",scenarioConnect,scenarioFishing,scenarioFishingSelective,scenarioFishingRate,"_Sim",sim,".fst"),compress_rate)
  save(fishing.rates,file=paste0(dir_results,"results_",Sc_name,"/Fishing_rates_Sc",scenarioConnect,scenarioFishing,scenarioFishingSelective,scenarioFishingRate,"_Sim",sim,".RData"))
